...
urlpatterns = [
    ...
    path("private/<str:private_link>/check/", views.crossword_private_check, name="crossword_private_check"),
    path("private/<str:private_link>/reveal/", views.crossword_private_reveal, name="crossword_private_reveal"),
